...
public class Stepdefs {
    ...
    @When("^a correct username \"([^\"]*)\" and too short password \"([^\"]*)\" are given$")
    public void a_correct_username_and_too_short_password_are_given(String username, String password) throws Throwable {
        register(username, password, password);
    }
